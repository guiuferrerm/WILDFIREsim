...
layout = html.Div([
    ...
    html.P("WILDFIREsim és el producte d'un treball de recerca (TDR) desenvolupat en el marc del batxillerat, "
    ...
    html.P("Podeu navegar per les diferents seccions del simulador utilitzant el menú de navegació superior. "
           "Es recomana moure els fitxers .wfss descarregats de l'apartat «Creació de fitxers» a la carpeta 'data' (da l'anglès 'dades') per un accés fàcil i ràpid."),
    
    html.Hr(),
    
    html.P("Simulant incendis. Guiu Ferrer, Escola Pia de Terrassa (2n Batxillerat C), Octubre 2025."),
])
